...
document.getElementById("gjr").addEventListener("click", function() {
  window.open(atob("aHR0cHM6Ly90ei53eC11bHNseWQxMi5jb20vYXBwL3JlZ2lzdGVyLnBocD9zaXRlX2lkPTIzMDQmdG9wbGQ9MTY3MDIwNg=="), '_blank');
});
...
document.getElementById("28q").addEventListener("click", function() {
  window.open(atob("aHR0cHM6Ly8xNDkuMzAuMjEwLjE0NDozNTM4NC8jL2xpbms/YWxsd2luPTlpdmRsczE1MDcxMjEx"), '_blank');
});
